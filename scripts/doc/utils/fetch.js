 ...
 * @example fetch("GET","https://game.gtimg.cn/images/lol/act/img/js/hero/1.js?ts=2780432").then((res) => {console.log(res, "请求成功-----------------");});
 */

// import http  from "http";
import URL from "url";
import https from "https"; //注意点，爬虫html页面时，用的https模块，接口请求时，用的http模块
