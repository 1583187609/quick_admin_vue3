...
const widgetAttrsTpls: CommonObj = {
  ...
  clearable: { label: "是否显示清除按钮", frequency: 0 },
  name: { label: "", remark: "原生属性", frequency: 0 },
  autocomplete: { label: "自动填充", remark: "原生属性", frequency: 0 },
  disabled: { label: "是否禁用", remark: "" },
  size: { label: "尺寸大小", remark: "" },
  readonly: { label: "是否只读", remark: "" },
};
// 控件属性
const widgetAttrsMap: CommonObj = {
  input: [
    ...
    { value: "minlength", label: "最小输入长度", frequency: 1 },
    { value: "maxlength", label: "最大输入长度", frequency: 2 },
    {
    ...
    { value: "formatter", label: "指定输入值的格式", effect: { type: ["text"] } },
    { value: "parser", label: "指定从格式化器输入中提取的值", effect: { type: ["text"] } },
    { value: "show-password", label: "是否显示切换密码图标", effect: { type: ["password"] } },
    "disabled",
    { tpl: "size", effect: { "type|not": ["textarea"] } },
    { value: "prefix-icon", label: "自定义前缀图标" },
    { value: "suffix-icon", label: "自定义后缀图标" },
    { value: "rows", label: "输入框行数", effect: { type: ["textarea"] } },
    {
      value: "autosize",
      label: "是否自适应高度",
    ...
    "name",
    "readonly",
    { value: "max", label: "最大值", remark: "原生属性" },
    { value: "min", label: "最小值", remark: "原生属性" },
    { value: "step", label: "数字间隔", effect: { type: ["nunmber"] }, remark: "原生属性" },
    { value: "resize", label: "能否被缩放" },
    { value: "autofocus", label: "自动获取焦点", remark: "原生属性" },
...
export function getWidgetAttrsFields(type: string): FormFieldAttrs[] {
  const propList: WidgetProp[] = widgetAttrsMap[type];
  if (!propList) {
