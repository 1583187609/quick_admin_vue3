...
1. 是一款对**开发效率、程序性能、用户体验、扩展维护**不断**追求极致**的中后台管理系统模板。
...
5. 自动文档：VitePress + Node 脚本，实现了通过 vue 文件中的注释生成组件使用说明文档，而无需手写 md 文件。
...
1. 从 2022 年 12 月至今，**初版**已经过一个完整企业级项目验证，**升级版**已改造完成。
