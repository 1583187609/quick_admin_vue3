        ...
        children: [
          {
            ...
            label: "系统设计",
            icon: `${menuIcons["10-1-1"]}`,
            path: "/code/one-site/system-design",
            type: 0,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            children: [
              {
                ...
                label: "页面设计",
                icon: `${menuIcons["10-1-2"]}`,
                path: "/code/one-site/system-design/pages",
                type: 1,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: `/code/one-site/system-design/pages/index.${fileSuffix}`,
              },
              {
                id: "40-10-1-2",
                label: "表设计",
                icon: `${menuIcons["10-1-1"]}`,
                path: "/code/one-site/system-design/tables",
                type: 1,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: `/code/one-site/system-design/tables/index.${fileSuffix}`,
              },
              {
                id: "40-10-1-3",
                label: "表详情",
                icon: `${menuIcons["10-1-1"]}`,
                path: "/code/one-site/system-design/tables/detail",
                type: 2,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: `/code/one-site/system-design/tables/detail/index.${fileSuffix}`,
              },
            ],
          },
          {
            ...
            label: "模板管理",
            icon: `${menuIcons["10-1-2"]}`,
            path: "/code/one-site/template-manage",
            type: 0,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            children: [
              {
                ...
                label: "表单项",
                icon: `${menuIcons["10-1-2"]}`,
                path: "/code/one-site/template-manage/form-items",
                type: 1,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: `/code/one-site/template-manage/form-items/index.${fileSuffix}`,
              },
              {
                id: "40-10-2-2",
                label: "表格列",
                icon: `${menuIcons["10-1-2"]}`,
                path: "/code/one-site/template-manage/table-cols",
                type: 1,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: `/code/one-site/template-manage/table-cols/index.${fileSuffix}`,
              },
              {
                id: "40-10-2-3",
                label: "基础按钮",
                icon: `${menuIcons["10-1-2"]}`,
                path: "/code/one-site/template-manage/base-btns",
                type: 1,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: `/code/one-site/template-manage/base-btns/index.${fileSuffix}`,
              },
              {
                id: "40-10-2-4",
                label: "表单校验",
                icon: `${menuIcons["10-1-1"]}`,
                path: "/code/one-site/template-manage/form-valid",
                type: 1,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: `/code/one-site/template-manage/form-valid/index.${fileSuffix}`,
              },
              {
                id: "40-10-2-5",
                label: "参数校验",
                icon: `${menuIcons["10-1-1"]}`,
                path: "/code/one-site/template-manage/args-valid",
                type: 1,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: `/code/one-site/template-manage/args-valid/index.${fileSuffix}`,
              },
              {
                id: "40-10-2-6",
                label: "数据库表字段",
                icon: `${menuIcons["10-1-2"]}`,
                path: "/code/one-site/template-manage/db-fields",
                type: 1,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: `/code/one-site/template-manage/db-fields/index.${fileSuffix}`,
              },
            ],
          },
        ],
