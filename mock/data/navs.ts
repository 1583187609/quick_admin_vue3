        ...
        children: [
          {
            ...
            label: "工程模板",
            icon: `${menuIcons["10-1-1"]}`,
            path: "/code/one-site/project-template",
            type: 0,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            children: [
              {
                ...
                label: "基础模板",
                icon: `${menuIcons["10-1-2"]}`,
                path: "/code/one-site/base-template",
                type: 0,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                children: [
                  {
                    ...
                    label: "表单项",
                    icon: `${menuIcons["10-1-2"]}`,
                    path: "/code/one-site/base-template/form-items",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/base-template/form-items/index.${fileSuffix}`,
                  },
                  {
                    id: "40-10-1-2",
                    label: "表格列",
                    icon: `${menuIcons["10-1-2"]}`,
                    path: "/code/one-site/base-template/table-cols",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/base-template/table-cols/index.${fileSuffix}`,
                  },
                  {
                    id: "40-10-1-3",
                    label: "基础按钮",
                    icon: `${menuIcons["10-1-2"]}`,
                    path: "/code/one-site/base-template/base-btns",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/base-template/base-btns/index.${fileSuffix}`,
                  },
                  {
                    id: "40-10-1-4",
                    label: "表单校验",
                    icon: `${menuIcons["10-1-1"]}`,
                    path: "/code/one-site/base-template/form-valid",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/base-template/form-valid/index.${fileSuffix}`,
                  },
                  {
                    id: "40-10-1-5",
                    label: "参数校验",
                    icon: `${menuIcons["10-1-1"]}`,
                    path: "/code/one-site/base-template/args-valid",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/base-template/args-valid/index.${fileSuffix}`,
                  },
                  {
                    id: "40-10-1-6",
                    label: "数据库表字段",
                    icon: `${menuIcons["10-1-2"]}`,
                    path: "/code/one-site/base-template/db-fields",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/base-template/db-fields/index.${fileSuffix}`,
                  },
                ],
              },
              {
                ...
                label: "组件模板",
                icon: `${menuIcons["10-1-2"]}`,
                path: "/code/one-site/component-template",
                type: 0,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                children: [
                  {
                    ...
                    label: "组件列表",
                    icon: `${menuIcons["10-1-2"]}`,
                    path: "/code/one-site/component-template/list",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/component-template/list/index.${fileSuffix}`,
                  },
                  {
                    id: "40-10-2-2",
                    label: "组件详情",
                    icon: `${menuIcons["10-1-2"]}`,
                    path: "/code/one-site/component-template/detail",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/component-template/detail/index.${fileSuffix}`,
                  },
                ],
              },
              {
                ...
                label: "页面模板",
                icon: `${menuIcons["10-1-2"]}`,
                path: "/code/one-site/page-template",
                type: 0,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                children: [
                  {
                    ...
                    label: "页面列表",
                    icon: `${menuIcons["10-1-2"]}`,
                    path: "/code/one-site/page-template/list",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/page-template/list/index.${fileSuffix}`,
                  },
                  {
                    id: "40-10-3-2",
                    label: "页面详情",
                    icon: `${menuIcons["10-1-2"]}`,
                    path: "/code/one-site/page-template/detail",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/page-template/detail/index.${fileSuffix}`,
                  },
                ],
              },
              {
                ...
                label: "模块模板",
                icon: `${menuIcons["10-1-2"]}`,
                path: "/code/one-site/module-template",
                type: 0,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                children: [
                  {
                    ...
                    label: "模块列表",
                    icon: `${menuIcons["10-1-2"]}`,
                    path: "/code/one-site/module-template/list",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/module-template/list/index.${fileSuffix}`,
                  },
                  {
                    id: "40-10-4-2",
                    label: "模块详情",
                    icon: `${menuIcons["10-1-2"]}`,
                    path: "/code/one-site/module-template/detail",
                    type: 1,
                    auth_codes: null,
                    status: 1,
                    is_cache: 1,
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: `/code/one-site/module-template/detail/index.${fileSuffix}`,
                  },
                ],
              },
              {
                ...
                label: "工程模板",
                icon: `${menuIcons["10-1-2"]}`,
                path: "/code/one-site/project-template/list",
                type: 1,
                auth_codes: null,
                status: 1,
                is_cache: 1,
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: `/code/one-site/project-template/list/index.${fileSuffix}`,
              },
              // {
              //   id: "40-10-10-2",
              //   label: "工程设计",
              //   icon: `${menuIcons["10-1-1"]}`,
              //   path: "/code/one-site/project-template/design",
              //   type: 1,
              //   auth_codes: null,
              //   status: 1,
              //   is_cache: 1,
              ...
              //   create_time: Random.datetime(),
              //   update_time: Random.datetime(),
              //   component: `/code/one-site/project-template/design/index.${fileSuffix}`,
              // },
              // {
              //   id: "40-10-10-3",
              //   label: "表详情",
              //   icon: `${menuIcons["10-1-1"]}`,
              //   path: "/code/one-site/project-template/tables/detail",
              //   type: 2,
              //   auth_codes: null,
              //   status: 1,
              //   is_cache: 1,
              ...
              //   create_time: Random.datetime(),
              //   update_time: Random.datetime(),
              //   component: `/code/one-site/project-template/tables/detail/index.${fileSuffix}`,
              // },
            ],
          },
        ],
