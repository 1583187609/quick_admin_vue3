...
export default [
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            path: "/common-center/user/detail",
            type: 2,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/common-center/user/detail/index.${fileSuffix}`,
          },
        ],
      },
      {
  ...
  },
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/base-template/db-fields/index.${fileSuffix}`,
          },
          {
            id: "45-10-1-2",
            label: "基础按钮",
            icon: `${menuIcons["10-1-2"]}`,
            path: "/code-one/base-template/base-btns",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/base-template/base-btns/index.${fileSuffix}`,
          },
          {
            id: "45-10-1-3",
            label: "表单项",
            icon: `${menuIcons["10-1-2"]}`,
            path: "/code-one/base-template/form-items",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/base-template/form-items/index.${fileSuffix}`,
          },
          {
            id: "45-10-1-4",
            label: "表格列",
            icon: `${menuIcons["10-1-2"]}`,
            path: "/code-one/base-template/table-cols",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/base-template/table-cols/index.${fileSuffix}`,
          },
          {
            id: "45-10-1-5",
            label: "表单校验",
            icon: `${menuIcons["10-1-1"]}`,
            path: "/code-one/base-template/form-valid",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/base-template/form-valid/index.${fileSuffix}`,
          },
          {
            id: "45-10-1-6",
            label: "参数校验",
            icon: `${menuIcons["10-1-1"]}`,
            path: "/code-one/base-template/args-valid",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/base-template/args-valid/index.${fileSuffix}`,
          },
        ],
      },
      {
        ...
        label: "组件模板",
        icon: `${menuIcons["10-1-2"]}`,
        path: "/code-one/component-template",
        type: 0,
        auth_codes: null,
        status: 1,
        is_cache: 1,
        ...
        children: [
          {
            ...
            label: "组件列表",
            icon: `${menuIcons["10-1-2"]}`,
            path: "/code-one/component-template/list",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/component-template/list/index.${fileSuffix}`,
          },
          {
            id: "45-10-2-2",
            label: "组件详情",
            icon: `${menuIcons["10-1-2"]}`,
            path: "/code-one/component-template/detail",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/component-template/detail/index.${fileSuffix}`,
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            label: "页面列表",
            icon: `${menuIcons["10-1-2"]}`,
            path: "/code-one/page-template/list",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/page-template/list/index.${fileSuffix}`,
          },
          {
            id: "45-10-3-2",
            label: "页面详情",
            icon: `${menuIcons["10-1-2"]}`,
            path: "/code-one/page-template/detail",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/page-template/detail/index.${fileSuffix}`,
          },
        ],
      },
      {
        id: "45-10-4",
        label: "模块模板",
        icon: `${menuIcons["45-10-4"]}`,
        path: "/code-one/module-template",
        type: 0,
        auth_codes: null,
        status: 1,
        is_cache: 1,
        ...
        children: [
          {
            id: "45-10-4-1",
            label: "模块列表",
            icon: `${menuIcons["45-10-4-1"]}`,
            path: "/code-one/module-template/list",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/module-template/list/index.${fileSuffix}`,
          },
          {
            id: "45-10-4-2",
            label: "模块详情",
            icon: `${menuIcons["45-10-4-2"]}`,
            path: "/code-one/module-template/detail",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/module-template/detail/index.${fileSuffix}`,
          },
        ],
      },
      {
        id: "45-10-10-1",
        label: "工程模板",
        icon: `${menuIcons["45-10-10-1"]}`,
        path: "/code-one/project-template",
        type: 0,
        auth_codes: null,
        status: 1,
        is_cache: 1,
        ...
        children: [
          {
            ...
            label: "工程列表",
            icon: `${menuIcons["45-10-10-1"]}`,
            path: "/code-one/project-template/list",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/project-template/list/index.${fileSuffix}`,
          },
          {
            id: "45-10-10-2",
            label: "工程详情",
            icon: `${menuIcons["45-10-10-2"]}`,
            path: "/code-one/project-template/detail",
            type: 1,
            auth_codes: null,
            status: 1,
            is_cache: 1,
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: `/code-one/project-template/detail/index.${fileSuffix}`,
          },
        ],
      },
      // {
      ...
      //   label: "工程设计",
      //   icon: `${menuIcons["45-10-10-2"]}`,
      //   path: "/code-one/project-template/design",
      //   type: 1,
      //   auth_codes: null,
      //   status: 1,
      //   is_cache: 1,
      ...
      //   create_time: Random.datetime(),
      //   update_time: Random.datetime(),
      //   component: `/code-one/project-template/design/index.${fileSuffix}`,
      // },
      // {
      //   id: "45-10-10-3",
      //   label: "表详情",
      //   icon: `${menuIcons["45-10-10-3"]}`,
      //   path: "/code-one/project-template/tables/detail",
      //   type: 2,
      //   auth_codes: null,
      //   status: 1,
      //   is_cache: 1,
      ...
      //   create_time: Random.datetime(),
      //   update_time: Random.datetime(),
      //   component: `/code-one/project-template/tables/detail/index.${fileSuffix}`,
      // },
    ],
  },
  {
    ...
    children: [
      {
        ...
        create_time: Random.datetime(),
        update_time: Random.datetime(),
        component: `/easy-note/user/index.${fileSuffix}`,
      },
      {
        id: "1000-2",
        label: "题目列表",
        icon: `${menuIcons["1-1"]}`,
        path: "/easy-note/topic",
        type: 1,
        auth_codes: null,
        status: 1,
        is_cache: 1,
        ...
        create_time: Random.datetime(),
        update_time: Random.datetime(),
        component: `/easy-note/topic/index.${fileSuffix}`,
      },
      {
        id: "1000-3",
        label: "文章列表",
        icon: `${menuIcons["1-1"]}`,
        path: "/easy-note/article",
        type: 1,
        auth_codes: null,
        status: 1,
        is_cache: 1,
        ...
        create_time: Random.datetime(),
        update_time: Random.datetime(),
        component: `/easy-note/article/index.${fileSuffix}`,
      },
      {
        id: "1000-4",
        label: "行业列表",
        icon: `${menuIcons["1-1"]}`,
        path: "/easy-note/industry",
        type: 1,
        auth_codes: null,
        status: 1,
        is_cache: 1,
        ...
        create_time: Random.datetime(),
        update_time: Random.datetime(),
        component: `/easy-note/industry/index.${fileSuffix}`,
      },
    ],
  },
] as ResponseMenuItem[];
