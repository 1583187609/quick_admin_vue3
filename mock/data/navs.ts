    ...
    children: [
      {
        ...
        create_time: Random.datetime(),
        update_time: Random.datetime(),
        component: "/big-screen/travel/index.vue",
      },
      {
        id: "2-2",
        label: "其他大屏",
        ...
        create_time: Random.datetime(),
        update_time: Random.datetime(),
        component: "/big-screen/other/index.vue",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        create_time: Random.datetime(),
        update_time: Random.datetime(),
        component: "/three-dimensional/china/index.vue",
      },
      {
        id: "3-2",
        label: "世界地图",
        ...
        create_time: Random.datetime(),
        update_time: Random.datetime(),
        component: "/three-dimensional/world/index.vue",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        create_time: Random.datetime(),
        update_time: Random.datetime(),
        component: "/gis/demo-1/index.vue",
      },
      {
        id: "4-2",
        label: "GIS-示例2",
        ...
        create_time: Random.datetime(),
        update_time: Random.datetime(),
        component: "/gis/demo-2/index.vue",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        create_time: Random.datetime(),
        update_time: Random.datetime(),
        component: "/demo/eight/index.vue",
      },
      {
        id: "40-9",
        label: "示例9",
      ...
      },
      {
        ...
        children: [
            ...
            children: [
              {
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: "/test/test-10/one/one.vue",
              },
              {
                id: "41-10-1-2",
                label: "菜单1-2",
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: "/test/test-10/one/two.vue",
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                create_time: Random.datetime(),
                update_time: Random.datetime(),
                component: "/test/test-10/two/one.vue",
              },
              {
                id: "41-10-2-2",
                label: "菜单2-2",
                ...
                children: [
                  {
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: "/test/test-10/two/two/one.vue",
                  },
                  {
                    id: "41-10-2-2-2",
                    label: "菜单2-2-2",
                    ...
                    create_time: Random.datetime(),
                    update_time: Random.datetime(),
                    component: "/test/test-10/two/two/two.vue",
                  },
                ],
              },
            ],
          },
          {
            ...
            create_time: Random.datetime(),
            update_time: Random.datetime(),
            component: "/test/test-10/three.vue",
          },
          {
            id: "41-10-4",
            label: "菜单4",
            ...
            update_time: Random.datetime(),
            disabled: true,
            component: "/test/test-10/four.vue",
          },
        ],
      },
    ],
