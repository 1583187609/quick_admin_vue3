...
&emsp;&emsp;地址链接：  
&emsp;&emsp;[`Github `地址](`https://1583187609.github.io/produce/flex-layout)`（国外服务，初次加载较慢）  
&emsp;&emsp;[`Gitee `地址](`http://fanlichuan.gitee.io/produce/flex-layout/index.html)`（暂不可用，服务维护升级）

::: demo 
/demos/2_组件_comp/10_全局_global/12_弹性布局基础类/1_BasicUse.vue
:::
